    ...
    def handle(self, *args, **kwargs):
        for x in ItemType:
            ...
            for i in range(0, kwargs['total']):
                ...
                item.active_timestamp = datetime.datetime(2019, 1, 1, 0, 0, 0,
                                                          tzinfo=pytz.timezone(
                                                              'Asia/Kuala_Lumpur'))
                item.expiry_timestamp = datetime.datetime(2020, 1, 1, 0, 0, 0,
                                                          tzinfo=pytz.timezone(
                                                              'Asia/Kuala_Lumpur'))
                ...
                price.effective_timestamp = datetime.datetime(2019, 1, 1, 0, 0,
                                                              0,
                                                              tzinfo=pytz.timezone(
                                                                  'Asia/Kuala_Lumpur'))
